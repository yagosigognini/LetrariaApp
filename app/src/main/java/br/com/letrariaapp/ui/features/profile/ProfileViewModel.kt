...
class ProfileViewModel : ViewModel() {
    ...
    fun updateUserProfile(name: String, aboutMe: String, newImageUri: Uri?) { /* ... (sem mudanças) ... */ }
    private suspend fun updateUserDocument(uid: String, name: String, aboutMe: String, imageUrl: String?) { /* ... (sem mudanças) ... */ }
    fun resetUpdateStatus() { /* ... (sem mudanças) ... */ }
